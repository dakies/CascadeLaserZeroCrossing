...
class SocketClientThread(threading.Thread):
    ...
    def _handle_RECEIVE(self, cmd):
        try:
            ...
            if bytes_data != -1:
                [header, index, lostrate, oscrate, buffsize, ch1_size, ch2_size, resolution] = struct.unpack(
                    '=16sQQLLLLL', bytes_data[0:52])
...
if __name__ == "__main__":
    ...
    while 1:
        ...
        if a.type == 1:  # DATA
            ...
            if i == NSAMP:
                print("qsize ", client.reply_q.qsize(), "data rate is ",
                      NSAMP * 2 ** 16 / (t - tprev) / 1024 / 1024)  # MBytes/second
                i = 0
                tprev = t
                print(a.data['params'])
            # Handle Data HERE!!!!
